...
from serv_gcis_nat_gov_tw_pub.spiders.crawler import PDF_LOG
...
class ServGcisNatGovTwPubPipeline(object):
...
class PdfFilesPipeline(FilesPipeline):
    ...
    def get_media_requests(self, item, info):
        yield scrapy.Request(item['file_urls'][0], meta={'filename': item['files']})
